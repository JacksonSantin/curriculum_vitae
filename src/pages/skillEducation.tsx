        ...
        <div className="row">
          <div className="col-sm-4">
            <section className="section-info section-skill">
              ...
              <h3>Skills</h3>
              <div className="skill-holder owl-carousel owl-theme d-block" style={{ opacity: 1 }}>
                <div className="owl-wrapper-outer">
                  <div className="owl-wrapper d-block">
                    <div className="owl-item">
                      <div className="skill-area">
                        <div className="skill-title">
                          <h4><u>Profissional</u></h4>
                        </div>
                        <div className="skillbar clearfix" data-percent="30%">
                          ...
                          <div className="skillbar-bar to-animate" style={{ width: '30%' }}></div>
                        ...
                        <div className="skillbar clearfix" data-percent="95%">
                          ...
                          <div className="skillbar-bg"></div>
                          <div className="skillbar-bar to-animate" style={{ width: '95%' }}></div>
                        ...
                        <div className="skillbar clearfix" data-percent="90%">
                          ...
                          <div className="skillbar-bg"></div>
                          <div className="skillbar-bar to-animate" style={{ width: '90%' }}></div>
                        ...
                        <div className="skillbar clearfix" data-percent="20%">
                          ...
                          <div className="skillbar-bg"></div>
                          <div className="skillbar-bar to-animate" style={{ width: '20%' }}></div>
                ...
                <div className="row">
                  ...
                  <div className="col-sm-12">
                    <div className="time-item">
                      ...
                      <h4 className="time-title"> IESTA - Instituto Estádual Santo Tomás de Aquino </h4>
