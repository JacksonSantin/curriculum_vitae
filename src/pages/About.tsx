...
import { FiEdit, FiFacebook, FiGithub, FiInstagram, FiLinkedin, FiTwitter } from "react-icons/fi";
        ...
        <div className="row">
          <div className="col-sm-8 col-sm-pull-4">
            <section className="section-info section-aboutme">
              ...
              <h3>Sobre Mim</h3>
              <p>
                Dedicação. Essa palavra me difine bem. Procuro sempre fazer tudo do jeito mais correto possível,
                sempre pensando no próximo. Pratico programação sempre que tenho um tempo sobrando,
                procuro estar sempre por dentro das notícias que mais me interessam, tecnologia, é claro.
                Gosto de uma boa música, trabalhar ouvindo um som, bons amigos e principalmente, uma boa equipe com quem
              ...
              <div className="stacks">
                <ul>
                  <li>
                    ...
                    <a href="https://purecss.io/" target="_blank" rel="noopener noreferrer">
